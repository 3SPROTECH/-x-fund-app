...
ActiveRecord::Schema[8.1].define(version: 2026_02_27_000001) do
  ...
  create_table "analyst_reports", force: :cascade do |t|
    ...
    t.text "comment"
    t.datetime "created_at", null: false
    t.jsonb "financial_metrics", default: {}, null: false
    t.bigint "investment_project_id", null: false
    t.string "recommendation"
    t.jsonb "report_data", default: {}, null: false
    t.jsonb "risk_factors", default: {}, null: false
  ...
  create_table "chat_messages", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["investment_project_id", "created_at"], name: "idx_chat_messages_on_project_and_date"
    t.index ["investment_project_id", "sender_id", "read_at"], name: "idx_chat_messages_unread"
    t.index ["investment_project_id"], name: "index_chat_messages_on_investment_project_id"
  ...
  create_table "investment_projects", force: :cascade do |t|
    ...
    t.text "yousign_admin_signature_link"
    t.string "yousign_admin_signer_id"
